// collections_screen.dart — image depuis le téléphone pour la collection
import 'dart:async';
...
class _CollectionsScreenState extends State<CollectionsScreen>
  ...
  Future<void> _leaveOrDelete(CollectionModel col) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Text(isOwner ? 'Supprimer ?' : 'Quitter ?',
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text(isOwner ? 'Supprimer' : 'Quitter',
  ...
  void _openDetail(CollectionModel col) {
    Navigator.push(context, MaterialPageRoute(
      builder: (_) => CollectionDetailScreen(
        collection: col,
        myUserId: _myUserId ?? ''))).then((_) => _load());
  }
  ...
  Widget _fab(String label, IconData icon, List<Color> colors, VoidCallback onTap) =>
    Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: colors),
        borderRadius: BorderRadius.circular(16),
        boxShadow: [BoxShadow(color: colors[0].withValues(alpha:0.5),
    ...
    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ShaderMask(
        shaderCallback: (b) => const LinearGradient(
          colors: [Color(0xFF7C3AED), Color(0xFFDB2777)]).createShader(b),
        child: const Icon(Icons.auto_awesome, size: 80, color: Colors.white)),
      const SizedBox(height: 24),
      const Text('Aucune collection', style: TextStyle(color: Colors.white,
          fontSize: 22, fontWeight: FontWeight.w900)),
      const SizedBox(height: 10),
      Text('Crée ta première collection\nou rejoins celle d\'un ami !',
...
class _CollectionCard extends StatefulWidget {
  ...
  const _CollectionCard({
    required this.collection, required this.myUserId,
    required this.palette, required this.onTap,
    required this.onLeaveOrDelete, required this.onShare});
...
class _CollectionCardState extends State<_CollectionCard> {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            begin: Alignment.topLeft, end: Alignment.bottomRight,
            colors: [p[0].withValues(alpha:0.85), p[1].withValues(alpha:0.85),
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  Row(children: [
                    if (_isOwner) _badge('Admin', Icons.shield_rounded, Colors.amber),
                    const SizedBox(width: 6),
                    _badge(widget.collection.cooldownLabel, Icons.timer_rounded, Colors.white),
                    const SizedBox(width: 6),
                    PopupMenuButton<String>(
                      ...
                      itemBuilder: (_) => [
                        ...
                        PopupMenuItem(value: 'leave',
                          child: Row(children: [
                            Icon(_isOwner ? Icons.delete : Icons.exit_to_app,
                                color: Colors.red, size: 18),
                            const SizedBox(width: 10),
                            Text(_isOwner ? 'Supprimer' : 'Quitter',
                ...
                const Spacer(),
                Row(children: [
                  Expanded(child: _canOpen ? _availBadge() : _timerBadge()),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('Appuie pour voir la collection',
  ...
  Widget _availBadge() => Container(
    ...
    child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      SizedBox(width: 6),
      Text('Pack disponible !', style: TextStyle(color: Colors.white,
  ...
  Widget _timerBadge() => Container(
    ...
    child: Row(children: [
      const Icon(Icons.hourglass_bottom_rounded, color: Colors.white54, size: 14),
      const SizedBox(width: 6),
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text('Prochain pack', style: TextStyle(
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
//   ÉCRAN CRÉER COLLECTION — avec image depuis le téléphone
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

class _CreateCollectionScreen extends StatefulWidget {
  const _CreateCollectionScreen();
  @override
  State<_CreateCollectionScreen> createState() => _CreateCollectionScreenState();
}
...
class _CreateCollectionScreenState extends State<_CreateCollectionScreen> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Center(child: Column(
                    ...
                    children: [
                      Icon(_imageBytes != null
                          ? Icons.edit_rounded : Icons.add_photo_alternate_rounded,
                          color: Colors.white, size: 32),
                      const SizedBox(height: 8),
                      Text(_imageBytes != null
                          ? 'Changer l\'image' : 'Ajouter une image de couverture',
                        style: TextStyle(
                      ...
                      if (_nameCtrl.text.isNotEmpty)
                        Text(_nameCtrl.text, style: const TextStyle(
          ...
          const SizedBox(height: 12),
          _field(_nameCtrl, 'Nom de la collection *', Icons.style_rounded,
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    gradient: sel ? const LinearGradient(
                      colors: [Color(0xFF7C3AED), Color(0xFFDB2777)]) : null,
          ...
          Container(
            ...
            child: Row(children: [
              const Icon(Icons.people_rounded, color: Colors.white54, size: 22),
              const SizedBox(width: 14),
              Expanded(child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Membres peuvent ajouter des cartes',
                    style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
                  Text('Sinon, seul l\'admin peut ajouter',
  ...
  Widget _field(TextEditingController c, String hint, IconData icon,
    ...
    TextField(
      controller: c, onChanged: onChanged,
      style: const TextStyle(color: Colors.white),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        ShaderMask(
          shaderCallback: (b) => const LinearGradient(
            colors: [Color(0xFF0891B2), Color(0xFF2563EB)]).createShader(b),
          child: const Icon(Icons.group_add_rounded, size: 44, color: Colors.white)),
        const SizedBox(height: 12),
        const Text('Rejoindre une collection',
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  onTap: _ctrl.text.length == 6
                      ? () => Navigator.pop(context, _ctrl.text) : null,
                  child: const Padding(
                    padding: EdgeInsets.symmetric(vertical: 16),
                    child: Text('Rejoindre', textAlign: TextAlign.center,
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Container(width: 40, height: 4,
          decoration: BoxDecoration(color: Colors.white24,
              borderRadius: BorderRadius.circular(2))),
        const SizedBox(height: 20),
        Text('Inviter dans « ${collection.name} »',
        ...
        Container(
          ...
          child: Column(children: [
            ...
            ShaderMask(
              shaderCallback: (b) => const LinearGradient(
                colors: [Color(0xFF7C3AED), Color(0xFFDB2777)]).createShader(b),
              child: Text(collection.code, style: const TextStyle(
